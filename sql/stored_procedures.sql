...
AS
$$
INSERT INTO METADATA_SCHEMA_CHANGES(FIELD_NAME, JSON_CPATH, CHANGE_TYPE)
SELECT FIELD_NAME, JSON_SPATH, 'NEW_FIELD',NULL,DATA_TYPE
FROM METADATA_JSON_STRUCTURE m
LEFT JOIN METADATA_TABLE_DEFINITION t
ON m.JSON_SPATH = t.JSON_DPATH
WHERE t.JSON_DPATH IS NULL;
